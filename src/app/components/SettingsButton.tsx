...
import ImportExportModal from "./ImportExportModal"; // Importa o sub-modal
...
const SettingsModalComponent: React.FC<SettingsModalProps> = ({ isOpen, onClose }) => {
  ...
  // Estado local para gerenciar a abertura do sub-modal de Import/Export
  const [isDataModalOpen, setIsDataModalOpen] = useState(false);

  if (!isOpen) return null;

  return (
    // Modal Principal (Configurações)
    <div
    ...
    >
      ...
      >
        ...
        <div className="p-4 sm:p-6 border-b border-yellow-500/50 flex justify-between items-center sticky top-0 bg-gray-900/90 z-10">
          {/* I18N: Usamos a chave 'data_modal_title' como título temporário para Configurações */}
        ...
        <div className="p-4 sm:p-6 text-left space-y-4 text-gray-300">
          ...
          {/* Opção 1: Importar / Exportar Dados */}
          <button
      ...
      {/* 💥 SUB-MODAL: Importar/Exportar (Gerenciado pelo estado local) */}
      <ImportExportModal
