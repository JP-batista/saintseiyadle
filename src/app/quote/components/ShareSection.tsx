...
interface ShareSectionProps {
  ...
  isWin: boolean; // Mantemos 'isWin' para o caso de desistência
}

const ShareSectionComponent: React.FC<ShareSectionProps> = ({ attemptsCount, isWin }) => {
  ...
  const shareString = useMemo(() => {
    ...
    const titleKey = isWin ? 'share_title_quote_win' : 'share_title_quote_lose';
    // (Ex: "Acertei a fala #SaintSeiyaDLE na 5ª tentativa! 💬")
  ...
  return (
    ...
    >
      ...
      <div className="p-4 border-t border-gray-700/50 flex flex-col sm:flex-row gap-3">
        ...
        {/*
        // ⬇️⬇️⬇️ BOTÃO DO "X" ATUALIZADO ⬇️⬇️⬇️
        */}
        <button
