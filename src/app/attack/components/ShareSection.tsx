// src/app/attack/components/ShareSection.tsx
"use client";
...
interface ShareSectionProps {
  ...
  // Assumindo que também não há derrota, 'isWin' não é necessário
}
...
const ShareSectionComponent: React.FC<ShareSectionProps> = ({ attemptsCount }) => {
  ...
  const shareString = useMemo(() => {
    ...
    // ⬇️⬇️⬇️ ÚNICA MUDANÇA LÓGICA ⬇️⬇️⬇️
    // (Ex: "Acertei o golpe #SaintSeiyaDLE na 5ª tentativa! 💥")
    const title = t('share_title_attack_win', { count: attemptsCount });
